Процедура ОбработкаПроведения(Отказ,Режим)
	...
	Запрос.Текст =
		...
		|ИЗ
		|	Документ.ОтправкаПочты.ИнформацияООтправленныхДокументах КАК ОтправкаПочтыИнформацияООтправленныхДокументах
		|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ОтправкаПочты КАК ОтправкаПочты
